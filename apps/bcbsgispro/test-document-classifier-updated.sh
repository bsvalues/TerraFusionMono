...
# Test script for document classification with proper JSON handling
...
PLAT_MAP_TEXT="SURVEYOR'S CERTIFICATE AND DESCRIPTION BENTON COUNTY SUBDIVISION PLAT 2025-001 LOCATED IN THE NW 1/4 OF SECTION 12, TOWNSHIP 8 NORTH, RANGE 29 EAST, W.M. CITY OF KENNEWICK, BENTON COUNTY, WASHINGTON. I, John Smith, a Professional Land Surveyor, licensed by the State of Washington, certify that this plat accurately represents a survey completed by me in January 2025. This plat establishes 12 residential lots numbered 1 through 12 as indicated hereon. LEGAL DESCRIPTION: A PORTION OF THE NORTHWEST QUARTER OF SECTION 12, TOWNSHIP 8 NORTH, RANGE 29 EAST, WILLAMETTE MERIDIAN, BENTON COUNTY, WASHINGTON, MORE PARTICULARLY DESCRIBED AS FOLLOWS: COMMENCING AT THE NORTHWEST CORNER OF SAID SECTION 12; THENCE SOUTH 0°15'00\" EAST ALONG THE WEST LINE OF SAID NORTHWEST QUARTER, A DISTANCE OF 40.00 FEET TO THE TRUE POINT OF BEGINNING; CONTAINING 5.23 ACRES, MORE OR LESS."
...
cat > temp_deed.json << EOF
{
  "text": "WARRANTY DEED. THE GRANTOR, Jane Johnson, a single person, for and in consideration of Ten and No/100 Dollars ($10.00) and other valuable consideration in hand paid, conveys and warrants to THE GRANTEE, Robert Brown and Susan Brown, husband and wife, the following described real estate situated in Benton County, State of Washington: LEGAL DESCRIPTION: LOT 5, BLOCK 3, RIVERSIDE ADDITION TO THE CITY OF RICHLAND, ACCORDING TO THE PLAT THEREOF RECORDED IN VOLUME 9 OF PLATS, PAGE 78, RECORDS OF BENTON COUNTY, WASHINGTON. PARCEL NUMBER: 1-12345-678. Subject to: Covenants, conditions, restrictions and easements, if any, affecting title, which may appear in public record. DATED this 15th day of March, 2025."
}
EOF
...
# Create a temporary file with the JSON payload
cat > temp_survey.json << EOF
{
  "text": "RECORD OF SURVEY. LOCATED IN THE NE 1/4 OF SECTION 24, TOWNSHIP 9 NORTH, RANGE 28 EAST, W.M. BENTON COUNTY, WASHINGTON. SURVEYOR'S CERTIFICATE: THIS MAP CORRECTLY REPRESENTS A SURVEY MADE BY ME OR UNDER MY DIRECTION IN CONFORMANCE WITH THE REQUIREMENTS OF THE SURVEY RECORDING ACT AT THE REQUEST OF MICHAEL WILSON IN FEBRUARY 2025. FIELD BOOK REFERENCE: 456-78. SURVEY DATE: FEBRUARY 5-8, 2025. LEGEND: FOUND MONUMENT AS NOTED, SET 5/8 REBAR WITH CAP PLS 12345, CALCULATED POSITION, NOTHING SET. SCALE: 1 = 50. BEARINGS AND DISTANCES: FROM POINT A TO POINT B: N88°45'22\"E, 325.67 FEET, FROM POINT B TO POINT C: S01°15'38\"E, 412.33 FEET"
}
EOF
...
# Clean up temp files
rm temp_deed.json temp_survey.json temp_bla.json
