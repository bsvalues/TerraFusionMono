...
create function fn_LeaseGetTotalRIInterest (@input_lease_id varchar(20), @input_lease_yr int, @input_rev_num int)
...
declare @total_ri_interest_pct numeric(14,8)
set @total_ri_interest_pct = 0.0
...
select
	@total_ri_interest_pct = sum(isnull(lpa.interest_pct, 0.0))
from
...
and	lpa.interest_type_cd = 'RI'


return (isnull(@total_ri_interest_pct, 0.0))
