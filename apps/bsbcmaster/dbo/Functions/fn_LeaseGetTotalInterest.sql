...
create function fn_LeaseGetTotalInterest (@input_lease_id varchar(20), @input_lease_yr int, @input_rev_num int)
...
declare @total_interest_pct numeric(14,8)
set @total_interest_pct = 0.0
...
select
	@total_interest_pct = sum(isnull(lpa.interest_pct, 0.0))
from
...
return (isnull(@total_interest_pct, 0.0))
