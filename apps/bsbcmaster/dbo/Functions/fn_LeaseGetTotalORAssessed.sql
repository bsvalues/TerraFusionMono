...
create function fn_LeaseGetTotalORAssessed (@input_lease_id varchar(20), @input_lease_yr int, @input_rev_num int)
...
declare @total_or_assessed numeric(14,0)
set @total_or_assessed = 0
...
select
	@total_or_assessed = sum(isnull(pv.assessed_val, 0))
from
...
return (isnull(@total_or_assessed, 0))
