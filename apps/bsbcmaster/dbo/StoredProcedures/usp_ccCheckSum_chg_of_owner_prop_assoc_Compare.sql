...
/*
exec dbo.usp_ccCheckSum_chg_of_owner_prop_assoc_Compare 2,2013,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_chg_of_owner_prop_assoc_Compare
...
declare @TableName sysname 
    set @TableName = 'chg_of_owner_prop_assoc'
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_chg_of_owner_prop_assoc_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_chg_of_owner_prop_assoc_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_chg_of_owner_prop_assoc_old'
...
select * into #ccCheckSum_chg_of_owner_prop_assoc_new 
  from dbo.cc_checksum_chg_of_owner_prop_assoc_template
