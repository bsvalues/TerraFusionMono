...
create procedure WATaxStatementCreateAssociatedCopies_Current_Run
	@year numeric(4,0),
	@group_id int,
	@run_id int,
...
begin
	...
	where wts.group_id = @group_id and wts.year = @year 
	 and  wts.run_id = @run_id and wts.copy_type = 0
	and wts.agent_id > 0
