...
CREATE PROCEDURE dbo.CreateTransferTaxSuppStmnt
...
select @DueDate = convert(datetime, @date_string)
...
from
	tax_rate
where	bill.sup_tax_yr = tax_rate.tax_rate_yr
...
begin
	...
	from
		mineral_acct
	where	transfer_tax_stmnt.prop_id = mineral_acct.prop_id
	and	transfer_tax_stmnt.levy_group_id = @input_group_id
	and	transfer_tax_stmnt.levy_group_yr = @input_stmnt_yr
	and	transfer_tax_stmnt.levy_run_id = @input_run_id
	and	transfer_tax_stmnt.sup_num = @input_sup_num
