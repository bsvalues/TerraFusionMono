CREATE   PROCEDURE CreateFY_NY_SL_comp_sales_corp_score_location
...
INSERT INTO 
    comp_sales_corp_score_location
(
    szSubmarket
   ,lPoints
   ,lYear
...
SELECT 
    ...
    ,@lCopyToYear
 FROM 
    comp_sales_corp_score_location as csc LEFT JOIN 
 ...
 and csc.szSubmarket = fy_csc.szSubmarket
