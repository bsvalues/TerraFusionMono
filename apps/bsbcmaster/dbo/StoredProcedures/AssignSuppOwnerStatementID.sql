...
CREATE PROCEDURE AssignSuppOwnerStatementID
...
begin
	...
	FOR select bill.bill_id, bill.prop_id, bill.owner_id, bill.sup_num from bill, account, property
    	where   bill.sup_num    = @input_sup_num
	...
	order by bill.owner_id, property.geo_id, bill.prop_id
...
/*	DECLARE BILL SCROLL CURSOR
	...
	order by account.file_as_name, bill.owner_id, bill.prop_id
...
begin
	...
	order by address.addr_zip, account.file_as_name, bill.owner_id, bill.prop_id
end
