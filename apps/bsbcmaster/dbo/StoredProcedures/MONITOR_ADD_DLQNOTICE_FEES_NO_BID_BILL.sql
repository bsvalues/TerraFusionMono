...
CREATE procedure [dbo].[MONITOR_ADD_DLQNOTICE_FEES_NO_BID_BILL]
...
----- {CALL [MONITOR_ADD_DLQNOTICE_FEES_NO_BID_BILL('2021', '05/01/2022')}
...
and b.bill_id not in (select bill_id from assessment_bill with (nolock) where agency_id = 521) ---- 6015
