...
create procedure ChangeLogSelectPropertyYear
	@lPropertyID int,
	@lYear int
as
	...
	where
		...
		((change_log_propvalyr_vw.prop_val_yr is null and year(cl.dtChange) = @lYear) or change_log_propvalyr_vw.prop_val_yr = @lYear)
