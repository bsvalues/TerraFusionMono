...
CREATE procedure CreateTransferTaxStmntAgent
...
set
	agent_copy = 'T',
	agent_id = property.col_agent_id
from
	property
where
	property.prop_id = transfer_tax_stmnt.prop_id
...
and     property.col_agent_id is not null
and     property.col_agent_id <> 0
