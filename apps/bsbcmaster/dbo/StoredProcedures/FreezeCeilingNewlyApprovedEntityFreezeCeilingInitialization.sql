...
create procedure FreezeCeilingNewlyApprovedEntityFreezeCeilingInitialization
	@run_id int
as
...
exec FreezeCeilingNewlyApprovedEntityFreezeCeilingDeletion @run_id
