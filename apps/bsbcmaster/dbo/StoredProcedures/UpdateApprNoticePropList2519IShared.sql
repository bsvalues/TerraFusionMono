...
CREATE procedure UpdateApprNoticePropList2519IShared
...
begin 
	...
	begin
		...
		select @input_notice_yr,
		       	...
		       	'T'
		from   owner, prop_supp_assoc, property_val
		...
		and    exists (select * from shared_prop sp
	...
	begin
		...
		begin
			...
			select    distinct
				@input_notice_yr,
		       		...
		       		prop_supp_assoc.owner_tax_yr,	
		       		'T'
			from   owner, prop_supp_assoc, prop_group_assoc,  property_val
			where  prop_supp_assoc.owner_tax_yr = @input_notice_yr
			and    prop_supp_assoc.prop_id      = owner.prop_id
			and    prop_supp_assoc.owner_tax_yr = owner.owner_tax_yr
			and    prop_supp_assoc.sup_num      = owner.sup_num
		...
		begin
			...
			select    distinct
		       		...
		       		prop_supp_assoc.owner_tax_yr,	
		       		'T'
			from   owner, prop_supp_assoc, property_val, chg_of_owner, chg_of_owner_prop_assoc
			where  prop_supp_assoc.owner_tax_yr = @input_notice_yr
			and    prop_supp_assoc.prop_id      = owner.prop_id
			and    prop_supp_assoc.owner_tax_yr = owner.owner_tax_yr
			and    prop_supp_assoc.sup_num      = owner.sup_num
		...
		begin
			...
			select  distinct
				...
				owner.owner_id,
		       		...
		       		prop_supp_assoc.owner_tax_yr,	
		       		'T'
			from   owner, prop_supp_assoc,  property_val, property
			where  prop_supp_assoc.owner_tax_yr = @input_notice_yr
			and    prop_supp_assoc.prop_id      = owner.prop_id
			and    prop_supp_assoc.owner_tax_yr = owner.owner_tax_yr
			and    prop_supp_assoc.sup_num      = owner.sup_num
