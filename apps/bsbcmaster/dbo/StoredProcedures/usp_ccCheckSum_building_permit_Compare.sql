...
/*
exec dbo.usp_ccCheckSum_building_permit_Compare 2,2013,1,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_building_permit_Compare
...
declare @TableName sysname 
    set @TableName = 'building_permit'
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_building_permit_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_building_permit_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_building_permit_old'
declare @join_table_for_prop_id sysname
    set @join_table_for_prop_id = 'prop_building_permit_assoc' -- pk prop_id, bldg_permit_id
declare @join_syntax varchar(300)
    set @join_syntax = ' ON ' + @TableName + '.bldg_permit_id = '
                     + @join_table_for_prop_id + '.bldg_permit_id'   
...
select * into #ccCheckSum_building_permit_new 
  from dbo.cc_checksum_building_permit_template
