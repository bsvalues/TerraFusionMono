...
-- exec WATaxStatementLevyCreate_Insert_wa_tax_statement_levy 137,2010,59,28079

create procedure WATaxStatementLevyCreate_Insert_wa_tax_statement_levy
	@pacs_user_id int,
	@year numeric(4,0),
	@group_id int,
	@run_id int 
...
insert into dbo.wa_tax_statement_levy
(
   group_id
  ,year
  ,run_id
...
SELECT group_id
      ...
      ,prior_yr_tax_amount
      ,levy_part
  FROM dbo.wa_tax_statement_levy_current_run
