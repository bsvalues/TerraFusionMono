...
create procedure FreezeCeilingVerificationInitialization
	@run_id int
as
...
exec FreezeCeilingVerificationDeletion @run_id
...
-- Set the flag to calculate a freeze when the qualify year is the previous year
update
	freeze_ceiling_verification_run_detail
set
