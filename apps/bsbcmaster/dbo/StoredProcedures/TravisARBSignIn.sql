...
CREATE    PROCEDURE TravisARBSignIn
...
set @strSQL = @strSQL + ' dbo.fn_GetProtestReasonCodes( _arb_protest.prop_id, _arb_protest.prop_val_yr, _arb_protest.case_id) AS ''Protest Reason Codes'''
