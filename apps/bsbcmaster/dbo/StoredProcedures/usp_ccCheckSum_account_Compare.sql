...
/*
exec dbo.usp_ccCheckSum_account_Compare 2,2013,1,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_account_Compare
...
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_account_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_account_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_account_old'
...
select * into #ccCheckSum_account_new 
  from dbo.cc_checksum_account_template
