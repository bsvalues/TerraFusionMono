...
-- exec WATaxStatementLevyCreate_Insert_wa_tax_statement_assessment_fee_display 137,2010,59,28079

create procedure WATaxStatementLevyCreate_Insert_wa_tax_statement_assessment_fee_display
	@pacs_user_id int,
	@year numeric(4,0),
	@group_id int,
	@run_id int 
...
INSERT INTO dbo.wa_tax_statement_assessment_fee_display
( 
 [group_id]
,[year]
,[run_id]
...
SELECT [group_id]
      ...
      ,[agency_id]
      ,[order_num]
  FROM dbo.wa_tax_statement_assessment_fee_display_current_run
