...
begin
	...
	begin
		...
		FOR select bill.bill_id
		    ...
		    --and    bill.owner_id = @input_owner_id HS34427
...
set @output_amt_due = @property_tax_due + @delinquent_tax_due + @property_attorney_fee
