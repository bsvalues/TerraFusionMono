CREATE PROCEDURE CreateFY_NY_SL_income_sched_imprv_econ
...
SELECT 
 ...
 FROM 
    income_sched_imprv_econ as prf LEFT JOIN 
     (select @lInputFromYear as [year],economic_area,imprv_det_type_cd,imprv_det_meth_cd
        from income_sched_imprv_econ with (nolock) 
