...
--TFS # 31964 (HS ID: 155299): Sum of Benefit Acres using owner ID in assessment year not collections owner
--------------------------------------------------------------------------------------------
CREATE PROCEDURE UpdateSumBenefitAcres
@year numeric (4, 0),
@agencyID int,
...
join property p with (nolock)	----added join to property to pull col_owner_id
on p.prop_id = upv.prop_id
...
--join owner o with (nolock)	----commented out join to owner when adding join to property
