...
CREATE procedure [dbo].[monitor_REETInfo2]          
...
r.base_excise_due, r.excise_amount_paid, r.sale_date, 
 max(pm.image_id) as image_id, pm.image_type, pm.location, pm.scan_dt, pm.image_dt, pm.ref_id
...
on rip.prop_id = pm.ref_id
and pm.image_type = 'REET'
--and pm.ref_type = 'RT'

where completion_date >= '6/27/2019'

and completion_date <= '7/29/2019'
...
ria.addr_city, ria.addr_state, ria.addr_zip, rip.situs_display, rip.prop_id, r.sale_price, 
r.base_excise_due, r.excise_amount_paid, r.sale_date, 
 pm.image_id, pm.image_type, pm.location, pm.scan_dt, pm.image_dt, pm.ref_id
