...
create procedure FreezeCeilingAcceptSupplementGroupCalculation
	@run_id int
as
...
inner join
	freeze_ceiling_accept_supplement_group_run_detail as detail
on
...
begin
	...
	set @calculated_freeze_ceiling = convert(numeric(14,2), ((@prev_yr_freeze_taxable_amount_decimal * @prev_yr_m_n_o_tax_pct) + (@prev_yr_freeze_taxable_amount_decimal * @prev_yr_i_n_s_tax_pct)))
	...
	begin
		set @calculated_freeze_ceiling = (@calculated_freeze_ceiling * (@prev_yr_transfer_pct / 100))
	end
