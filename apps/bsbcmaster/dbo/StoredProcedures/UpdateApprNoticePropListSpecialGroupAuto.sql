...
CREATE procedure UpdateApprNoticePropListSpecialGroupAuto
...
begin 
	...
	/* select auto based on selection criteria */
	else if (@auto_option = 'S')
	begin
		if (@use_rend_19a = 'T')
		begin
