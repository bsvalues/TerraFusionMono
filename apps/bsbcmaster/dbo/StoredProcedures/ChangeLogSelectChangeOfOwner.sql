...
create procedure ChangeLogSelectChangeOfOwner
	@lChangeOfOwnerID int
as
	...
	from change_log_chgofownerid_vw as clv with(nolock)
	...
	where
		clv.chg_of_owner_id = @lChangeOfOwnerID
