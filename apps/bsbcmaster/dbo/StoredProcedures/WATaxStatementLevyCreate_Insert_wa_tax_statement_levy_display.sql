...
-- exec WATaxStatementLevyCreate_Insert_wa_tax_statement_levy_display 137,2010,59,28079

create procedure WATaxStatementLevyCreate_Insert_wa_tax_statement_levy_display
	@pacs_user_id int,
	@year numeric(4,0),
	@group_id int,
	@run_id int 
...
INSERT INTO dbo.wa_tax_statement_levy_display
(
 [group_id]
,[year]
,[run_id]
...
SELECT [group_id]
      ...
      ,[prior_yr_tax_amount]  
      ,[levy_part]
  FROM dbo.wa_tax_statement_levy_display_current_run
