...
/*
exec dbo.usp_ccCheckSum_subset_Compare 2,2013,1,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_subset_Compare
...
declare @TableName sysname 
    set @TableName = 'subset'
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_subset_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_subset_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_subset_old'
declare @join_table_for_prop_id sysname
    set @join_table_for_prop_id = 'property_val' 
declare @join_syntax varchar(300)
    set @join_syntax = ' ON ' + @TableName + '.subset_code = '
                     + @join_table_for_prop_id + '.subset_cd '   
...
select * into #ccCheckSum_subset_new 
  from dbo.cc_checksum_subset_template
