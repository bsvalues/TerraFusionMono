...
-- This stored procedure updates the owner_assoc data for a particular property-owner combo by
-- assigning it to a new property-owner combo.
-- 
-- History:
-- TrentN	05/19/2004	Created

CREATE PROCEDURE CopyOverallOwnerSegmentsToNewProperty
	@old_prop_id 	 	int,
	@old_sup_num 	 	int,
