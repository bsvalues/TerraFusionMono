...
--monitor command to run this monitor -- {call OwnerTransferNoChangetoTotalEX('2009', '4/5/2008', '12/31/2009')}
--client needs to modify the dates and year

CREATE procedure [dbo].[OwnerTransferNoChangetoTotalEX]
