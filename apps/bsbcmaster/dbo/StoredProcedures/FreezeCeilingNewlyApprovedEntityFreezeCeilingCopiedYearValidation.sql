...
create procedure FreezeCeilingNewlyApprovedEntityFreezeCeilingCopiedYearValidation
	@run_id int
as
...
set
	action_indicator = 1,
	action_message = 'Entity is not associated with the property for the Tax Year.',
...
-- Anything left over should have a copied freeze ceiling.
update
	freeze_ceiling_newly_approved_entity_freeze_ceiling_run_detail
set
	action_indicator = 2,
