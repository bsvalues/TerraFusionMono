...
/*
exec dbo.usp_ccCheckSum_property_val_Compare 2,2013,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_property_val_Compare
...
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_property_val_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_property_val_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_property_val_old'
...
select * into #ccCheckSum_property_val_new 
  from dbo.cc_checksum_property_val_template
