...
---here is how you set up the monitor call:  {Call monitor_miscreceiptpmtinfo_DateRange ('1/1/2017', '1/31/2017')}    
...
Create procedure [dbo].[monitor_miscreceiptpmtinfo_DateRange]          
