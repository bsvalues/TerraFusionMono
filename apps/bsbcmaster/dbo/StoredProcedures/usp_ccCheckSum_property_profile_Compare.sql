...
/*
exec dbo.usp_ccCheckSum_property_profile_Compare 2,2013,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_property_profile_Compare
...
declare @TableName sysname 
    set @TableName = 'property_profile'
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_property_profile_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_property_profile_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_property_profile_old'
...
select * into #ccCheckSum_property_profile_new 
  from dbo.cc_checksum_property_profile_template
