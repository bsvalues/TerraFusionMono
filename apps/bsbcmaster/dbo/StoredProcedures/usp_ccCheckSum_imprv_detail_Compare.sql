...
/*
exec dbo.usp_ccCheckSum_imprv_detail_Compare 2,2013,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_imprv_detail_Compare
...
declare @TableName sysname 
    set @TableName = 'imprv_detail'
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_imprv_detail_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_imprv_detail_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_imprv_detail_old'
...
select * into #ccCheckSum_imprv_detail_new 
  from dbo.cc_checksum_imprv_detail_template
