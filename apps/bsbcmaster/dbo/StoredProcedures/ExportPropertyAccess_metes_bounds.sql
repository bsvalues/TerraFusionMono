...
CREATE PROCEDURE [dbo].[ExportPropertyAccess_metes_bounds]
...
*/
	...
	set @sql = @sql + @sql2 + '
		...
		join property_legal_description as pld with (nolock)
		on pv.prop_id = pld.prop_id
		and pv.prop_val_yr = pld.prop_val_yr
