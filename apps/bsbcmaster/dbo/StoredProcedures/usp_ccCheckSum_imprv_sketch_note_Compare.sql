...
/*
exec dbo.usp_ccCheckSum_imprv_sketch_note_Compare 2,2013,1,1
*/
 
CREATE PROCEDURE dbo.usp_ccCheckSum_imprv_sketch_note_Compare
...
declare @TableName sysname 
    set @TableName = 'imprv_sketch_note'
declare @ccTemplateTable sysname
    set @ccTemplateTable = 'cc_checksum_imprv_sketch_note_template' -- this is also hard coded in one spot  
declare @new_table_name sysname
    set @new_table_name = '#ccCheckSum_imprv_sketch_note_new' -- this is also hard coded in one spot
declare @old_table_name sysname
    set @old_table_name = 'ccCheckSum_imprv_sketch_note_old'
...
select * into #ccCheckSum_imprv_sketch_note_new 
  from dbo.cc_checksum_imprv_sketch_note_template
