...
---here is how you set up the monitor call: {Call MonitorStateRemittance ('2/1/2017', '2/28/2017')} 
...
CREATE procedure [dbo].[MonitorStateRemittance] 
...
order by t.fund_number, case when p.payee_name in ('SUPERIOR COURT', 'CORRECT-SUP COURT', 'CORRECTION-SUP COURT') 
