...
-- exec WATaxStatementLevyCreate_Insert_wa_tax_statement_tax_history_comparison 137,2010,59,28079

create procedure WATaxStatementLevyCreate_Insert_wa_tax_statement_tax_history_comparison
	@pacs_user_id int,
	@year numeric(4,0),
	@group_id int,
	@run_id int 
...
INSERT INTO dbo.wa_tax_statement_tax_history_comparison
(
   [group_id]
  ,[year]
  ,[run_id]
...
SELECT [group_id]
      ...
      ,[order_num]
      ,[levy_part]
  FROM dbo.wa_tax_statement_tax_history_comparison_current_run
