...
-- exec WATaxStatementLevyCreate_Insert_wa_tax_statement_levy_details_display 137,2010,59,28079

create procedure WATaxStatementLevyCreate_Insert_wa_tax_statement_levy_details_display
	@pacs_user_id int,
	@year numeric(4,0),
	@group_id int,
	@run_id int 
...
insert into wa_tax_statement_levy_details_display
(
	group_id,
	year ,
	run_id ,
...
select 
	...
	gross_tax_amount,
	prior_yr_tax_amount
  from wa_tax_statement_levy_details_display_current_run	
