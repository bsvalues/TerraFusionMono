...
create procedure CompSalesLandSelectSales
	@subject_prop_id int,
...
select
	...
	property.geo_id,
	null,
	comp_sales_land_sale_vw.chg_of_owner_id,
	comp_sales_land_sale_vw.sl_type_cd,
	comp_sales_land_sale_vw.sl_ratio_type_cd,
	comp_sales_land_sale_vw.sl_dt,
	comp_sales_land_sale_vw.total_acres,
	comp_sales_land_sale_vw.total_square_feet,
	comp_sales_land_sale_vw.total_useable_acres,
	comp_sales_land_sale_vw.total_useable_square_feet,
	comp_sales_land_sale_vw.total_land_market,
...
inner join comp_sales_land_sale_vw with(nolock) on
	chg_of_owner_prop_assoc.chg_of_owner_id = comp_sales_land_sale_vw.chg_of_owner_id and
	property_val.prop_val_yr = comp_sales_land_sale_vw.prop_val_yr and
	(isnull(property_val.land_hstd_val, 0) + isnull(property_val.land_non_hstd_val, 0) + isnull(property_val.ag_market, 0) + isnull(property_val.timber_market, 0)) = comp_sales_land_sale_vw.max_land_market
...
set
	...
	left outer join situs with(nolock) on
		#sales_comp_land.prop_id = situs.prop_id and
