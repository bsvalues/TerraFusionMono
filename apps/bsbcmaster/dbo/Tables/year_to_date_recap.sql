CREATE TABLE [dbo].[year_to_date_recap] (
    ...
    CONSTRAINT [CPK_year_to_date_recap] PRIMARY KEY CLUSTERED ([pacs_user_id] ASC, [entity_id] ASC, [recap_yr] ASC) WITH (FILLFACTOR = 100)
);
