CREATE TABLE [dbo].[month_to_date_recap_refund] (
    ...
    CONSTRAINT [CPK_month_to_date_recap_refund] PRIMARY KEY CLUSTERED ([pacs_user_id] ASC, [entity_id] ASC) WITH (FILLFACTOR = 100)
);
