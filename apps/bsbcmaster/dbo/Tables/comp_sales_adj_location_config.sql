...
create trigger tr_comp_sales_adj_location_config_delete_insert_update_MemTable
on comp_sales_adj_location_config
...
set lDummy = 0
where szTableName = 'comp_sales_adj_location_config'
