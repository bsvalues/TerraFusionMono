CREATE TABLE [dbo].[year_to_date_recap_refund] (
    ...
    CONSTRAINT [CPK_year_to_date_recap_refund] PRIMARY KEY CLUSTERED ([pacs_user_id] ASC, [entity_id] ASC) WITH (FILLFACTOR = 100)
);
