CREATE TABLE [dbo].[imprv_exemption_assoc] (
    ...
    CONSTRAINT [CPK_imprv_exemption_assoc] PRIMARY KEY CLUSTERED ([prop_val_yr] ASC, [sup_num] ASC, [sale_id] ASC, [prop_id] ASC, [imprv_id] ASC, [owner_id] ASC, [entity_id] ASC, [exmpt_type_cd] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [CFK_imprv_exemption_assoc_prop_val_yr_sup_num_sale_id_prop_id_imprv_id] FOREIGN KEY ([prop_val_yr], [sup_num], [sale_id], [prop_id], [imprv_id]) REFERENCES [dbo].[imprv] ([prop_val_yr], [sup_num], [sale_id], [prop_id], [imprv_id])
);
...
CREATE NONCLUSTERED INDEX [idx_prop_id]
    ON [dbo].[imprv_exemption_assoc]([prop_id] ASC) WITH (FILLFACTOR = 90);
...
create trigger tr_imprv_exemption_assoc_update_ChangeLog
on imprv_exemption_assoc
for update
not for replication
as
...
for
     select d.prop_id, d.sup_num, d.prop_val_yr, d.imprv_id, d.sale_id, d.entity_id, d.exmpt_type_cd, d.owner_id, d.amount, d.exempt_pct, d.value_type, d.calc_amount, i.prop_id, i.sup_num, i.prop_val_yr, i.imprv_id, i.sale_id, i.entity_id, i.exmpt_type_cd, i.owner_id, i.amount, i.exempt_pct, i.value_type, i.calc_amount
from deleted as d
...
open curRows
fetch next from curRows into @old_prop_id, @old_sup_num, @old_prop_val_yr, @old_imprv_id, @old_sale_id, @old_entity_id, @old_exmpt_type_cd, @old_owner_id, @old_amount, @old_exempt_pct, @old_value_type, @old_calc_amount, @new_prop_id, @new_sup_num, @new_prop_val_yr, @new_imprv_id, @new_sale_id, @new_entity_id, @new_exmpt_type_cd, @new_owner_id, @new_amount, @new_exempt_pct, @new_value_type, @new_calc_amount
 
while ( @@fetch_status = 0 )
begin
     select @tvar_szRefID = @new_exmpt_type_cd + ' - ' + entity.entity_cd + ' - ' + convert(varchar(12), @new_imprv_id)
     ...
     begin
          if exists (
               ...
               where
                    chg_log_tables = 'imprv_exemption_assoc' and
          ...
          begin
               ...
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 4026, convert(varchar(255), @old_prop_id), convert(varchar(255), @new_prop_id) )
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 5002, convert(varchar(255), @old_sup_num), convert(varchar(255), @new_sup_num) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 4083, convert(varchar(255), @old_prop_val_yr), convert(varchar(255), @new_prop_val_yr) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 2275, convert(varchar(255), @old_imprv_id), convert(varchar(255), @new_imprv_id) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 4485, convert(varchar(255), @old_sale_id), convert(varchar(255), @new_sale_id) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 1757, convert(varchar(255), @old_entity_id), convert(varchar(255), @new_entity_id) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 1830, convert(varchar(255), @old_exmpt_type_cd), convert(varchar(255), @new_exmpt_type_cd) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 3493, convert(varchar(255), @old_owner_id), convert(varchar(255), @new_owner_id) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 178, convert(varchar(255), @old_amount), convert(varchar(255), @new_amount) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 5966, convert(varchar(255), @old_exempt_pct), convert(varchar(255), @new_exempt_pct) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 5494, convert(varchar(255), @old_value_type), convert(varchar(255), @new_value_type) )
               set @tvar_lChangeID = @@identity
     ...
     begin
          ...
          begin
               insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue )
               values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'U', 838, 8518, convert(varchar(255), @old_calc_amount), convert(varchar(255), @new_calc_amount) )
               set @tvar_lChangeID = @@identity
...
create trigger tr_imprv_exemption_assoc_delete_ChangeLog
on imprv_exemption_assoc
for delete
not for replication
as
...
declare curRows cursor
for
     select prop_id, sup_num, prop_val_yr, imprv_id, sale_id, entity_id, exmpt_type_cd, owner_id from deleted
for read only
 
open curRows
fetch next from curRows into @prop_id, @sup_num, @prop_val_yr, @imprv_id, @sale_id, @entity_id, @exmpt_type_cd, @owner_id
 
while ( @@fetch_status = 0 )
begin
     select @tvar_szRefID = @exmpt_type_cd + ' - ' + entity.entity_cd + ' - ' + convert(varchar(12), @imprv_id)
     from entity with(nolock)
     where entity_id = @entity_id
 
     insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
     values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'D', 838, 0, 'DELETED', 'DELETED', @tvar_szRefID )
     set @tvar_lChangeID = @@identity
...
create trigger tr_imprv_exemption_assoc_insert_ChangeLog
on imprv_exemption_assoc
for insert
not for replication
as
...
declare curRows cursor
for
     select prop_id, sup_num, prop_val_yr, imprv_id, sale_id, entity_id, exmpt_type_cd, owner_id, amount, exempt_pct, value_type, calc_amount from inserted
for read only
 
open curRows
fetch next from curRows into @prop_id, @sup_num, @prop_val_yr, @imprv_id, @sale_id, @entity_id, @exmpt_type_cd, @owner_id, @amount, @exempt_pct, @value_type, @calc_amount
...
begin
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 4026, null, convert(varchar(255), @prop_id), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 5002, null, convert(varchar(255), @sup_num), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 4083, null, convert(varchar(255), @prop_val_yr), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 2275, null, convert(varchar(255), @imprv_id), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 4485, null, convert(varchar(255), @sale_id), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 1757, null, convert(varchar(255), @entity_id), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 1830, null, convert(varchar(255), @exmpt_type_cd), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 3493, null, convert(varchar(255), @owner_id), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 178, null, convert(varchar(255), @amount), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 5966, null, convert(varchar(255), @exempt_pct), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 5494, null, convert(varchar(255), @value_type), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
     ...
     begin
          insert change_log with(rowlock) ( lPacsUserID, szSQLAccount, szMachineName, dtChange, szChangeType, iTableID, iColumnID, szOldValue, szNewValue, szRefID )
          values ( @tvar_lPacsUserID, system_user, host_name(), @tvar_dtNow, 'I', 838, 8518, null, convert(varchar(255), @calc_amount), @tvar_szRefID )
          set @tvar_lChangeID = @@identity
