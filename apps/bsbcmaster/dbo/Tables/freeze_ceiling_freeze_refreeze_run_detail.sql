CREATE TABLE [dbo].[freeze_ceiling_freeze_refreeze_run_detail] (
    [run_id]                            INT              NOT NULL,
    ...
    [prev_yr_hs_exemption]              VARCHAR (5)      NULL,
    ...
    [prev_yr_actual_new_val_hs]         NUMERIC (14)     NULL,
    [prev_yr_actual_new_val_nhs]        NUMERIC (14)     NULL,
    [prev_yr_actual_new_val_taxable]    NUMERIC (14)     NULL,
    ...
    [hs_exemption_refreeze]             BIT              NULL,
    [new_value_refreeze]                BIT              NULL,
    [transfer_freeze]                   BIT              NULL,
    [missing_freeze_tax_amount]         NUMERIC (14, 2)  NULL,
    [qualify_year_tax_amount]           NUMERIC (14, 2)  NULL,
    [hs_exemption_tax_amount]           NUMERIC (14, 2)  NULL,
    [new_value_tax_amount]              NUMERIC (14, 2)  NULL,
    [transfer_freeze_tax_amount]        NUMERIC (14, 2)  NULL,
    ...
    CONSTRAINT [CPK_freeze_ceiling_freeze_refreeze_run_detail] PRIMARY KEY CLUSTERED ([run_id] ASC, [prop_id] ASC, [owner_id] ASC, [entity_id] ASC, [tax_yr] ASC, [sup_num] ASC, [freeze_type] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [CFK_freeze_ceiling_freeze_refreeze_run_detail_run_id] FOREIGN KEY ([run_id]) REFERENCES [dbo].[freeze_ceiling_run] ([run_id])
);
...
CREATE NONCLUSTERED INDEX [idx_action_indicator]
    ON [dbo].[freeze_ceiling_freeze_refreeze_run_detail]([action_indicator] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_report_sort_order]
    ON [dbo].[freeze_ceiling_freeze_refreeze_run_detail]([report_sort_order] ASC);
