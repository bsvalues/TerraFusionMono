CREATE TABLE [dbo].[prelim_property_val] (
    ...
    CONSTRAINT [CPK_prelim_property_val] PRIMARY KEY CLUSTERED ([prop_val_yr] ASC, [sup_num] ASC, [prop_id] ASC) WITH (FILLFACTOR = 95)
);
...
CREATE NONCLUSTERED INDEX [idx_prop_id]
    ON [dbo].[prelim_property_val]([prop_id] ASC) WITH (FILLFACTOR = 90);
