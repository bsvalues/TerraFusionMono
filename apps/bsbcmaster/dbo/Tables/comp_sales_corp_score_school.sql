...
create trigger tr_comp_sales_corp_score_school_delete_insert_update_MemTable
on comp_sales_corp_score_school
...
set lDummy = 0
where szTableName = 'comp_sales_corp_score_school'
