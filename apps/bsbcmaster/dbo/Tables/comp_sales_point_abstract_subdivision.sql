...
create trigger tr_comp_sales_point_abstract_subdivision_delete_insert_update_MemTable
on comp_sales_point_abstract_subdivision
...
set lDummy = 0
where szTableName = 'comp_sales_point_abstract_subdivision'
