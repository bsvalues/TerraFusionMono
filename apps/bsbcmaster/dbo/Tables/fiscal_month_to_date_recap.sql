CREATE TABLE [dbo].[fiscal_month_to_date_recap] (
    ...
    CONSTRAINT [CPK_fiscal_month_to_date_recap] PRIMARY KEY CLUSTERED ([pacs_user_id] ASC, [entity_id] ASC, [recap_yr] ASC) WITH (FILLFACTOR = 100)
);
