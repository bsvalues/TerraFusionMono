CREATE TABLE [dbo].[delq_roll_bill] (
    ...
    CONSTRAINT [CPK_delq_roll_bill] PRIMARY KEY CLUSTERED ([bill_id] ASC, [sup_tax_yr] ASC, [sup_num] ASC, [entity_id] ASC, [prop_id] ASC, [owner_id] ASC) WITH (FILLFACTOR = 100)
);


GO

CREATE NONCLUSTERED INDEX [idx_bill_id]
    ON [dbo].[delq_roll_bill]([bill_id] ASC) WITH (FILLFACTOR = 90);
