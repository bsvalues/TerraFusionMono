...
create view [dbo].[__BentonRatioSheet] as 
SELECT DISTINCT 
...
--CAST(ISNULL(pv.land_hstd_val + pv.land_non_hstd_val, 0) - ISNULL(pv2.land_hstd_val + pv2.land_non_hstd_val, 0) AS numeric(18, 4)) / 
