...
create view [dbo].[BOE_Case] as 

SELECT        property.prop_id AS ParcelID, property.geo_id, property.simple_geo_id, property_val.prop_val_yr AS CaseYear,
 property_val.sup_num AS SupNumber, account.file_as_name AS Owner, 
						 ...
						 property_val.hood_cd,
						  ...
						  property_val.market, 
						  pacs_user_1.pacs_user_name AS operator_staff, 
                         pacs_user_1.full_name AS operator_staff_name, 
						 owner.owner_id, account.ref_id1, account_1.file_as_name AS protest_by_name,
					  appraiser_1.appraiser_nm AS hearing_appraisal_staff_name, 
									
						 _arb_protest.final_assessed_val as assessed_value, 
				
						 
						 appraiser.appraiser_nm AS Appraiser, 
						 aphd.docket_start_date_time AS hearing_scheduled_date, 
						 _arb_protest.docket_id,
						  property_val.last_appraiser_id, 
                         _arb_protest.appraiser_meeting_appraiser_id,
					     property_profile.imprv_type_cd, property_val.property_use_cd,
                         ...
                         CONVERT(int, arb_protest_protest_by_count_vw.protest_by_count) AS lProtestByCount,
						  ISNULL(aphd.offsite, 0) AS offsite, _arb_event_object.szObjectPath as img_path , _arb_event_object.dtObject,
						Xcoord, YCoord
