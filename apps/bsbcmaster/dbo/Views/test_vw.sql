...
FROM bill bill1 INNER JOIN
    bill ON bill1.bill_id = bill1.prev_bill_id RIGHT OUTER JOIN
    ...
    supp_roll_info.owner_id = prop_owner_entity_val1.owner_id AND
     supp_roll_info.prev_sup_num = prop_owner_entity_val1.sup_num
     AND 
    supp_roll_info.sup_yr = prop_owner_entity_val1.sup_yr INNER JOIN
    prop_owner_entity_val ON 
    supp_roll_info.prop_id = prop_owner_entity_val1.prop_id AND 
    supp_roll_info.owner_id = prop_owner_entity_val1.owner_id AND
     supp_roll_info.sup_num = prop_owner_entity_val1.sup_num AND
     supp_roll_info.sup_yr = prop_owner_entity_val1.sup_yr AND 
    prop_owner_entity_val1.owner_id = prop_owner_entity_val1.owner_id
     AND 
    prop_owner_entity_val1.prop_id = prop_owner_entity_val1.prop_id
     AND 
    prop_owner_entity_val1.sup_yr = prop_owner_entity_val1.sup_yr
     ON bill1.prop_id = prop_owner_entity_val1.prop_id AND 
