...
create view [dbo].[__permcrop_view] as 
...
) as sp on id.prop_id=sp.prop_id
...
group by 
id.prop_id,id.imprv_det_id,id.imprv_det_type_cd,permanent_crop_acres,ID.imprv_det_meth_cd,p.geo_id ,xcoord, YCoord,X,y ,pv.cycle , pv.hood_cd , imprv.imprv_state_cd ,pv.legal_acreage ,ac.file_as_name,
id.yr_built ,
