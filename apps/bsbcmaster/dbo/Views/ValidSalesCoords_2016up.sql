...
create view [dbo].[ValidSalesCoords_2016up] as

SELECT        chg_of_owner_prop_assoc.prop_id, sale.sl_ratio, sale.sl_financing_cd, sale.sl_ratio_type_cd , sale.land_only_sale as land_only, sale.sl_adj_cd, sale.sl_type_cd, sale.sl_state_cd, sale.sl_class_cd, sale.sl_price, CASE WHEN (CONVERT(varchar(10), sale.sl_dt, 101)) IS NULL 
...
FROM 
[Benton_spatial_data].[dbo].[PARCEL]) sp on sp.Prop_ID=chg_of_owner_prop_assoc.prop_id
