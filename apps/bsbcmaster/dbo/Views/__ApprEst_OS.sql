...
--create view [dbo].[__Apprest_gain_loss_] as
...
SELECT DISTINCT 
	...
	rtrim(permits.bldg_permit_cad_status)																				as permit_status, 
	permits.bldg_permit_sub_type_cd,
...
LEFT JOIN 
	(SELECT vw.prop_id, ROW_NUMBER() over (partition by vw.prop_id ORDER BY vw.bldg_permit_id DESC) AS order_id,vw.bldg_permit_status, vw.bldg_permit_issue_dt, vw.bldg_permit_active, building_permit.bldg_permit_cmnt,
		building_permit.bldg_permit_desc, vw.bldg_permit_num, building_permit.bldg_permit_dt_complete,building_permit.bldg_permit_cad_status,building_permit.bldg_permit_sub_type_cd
     ...
     -- ,[CENTROID_Y] as YCoord
		...
		--and pv.hood_cd like '1%'
			...
			--and sales.sl_dt>='01/01/2016'
				...
				or pv.property_use_cd ='94'
				--and pv.property_use_cd ='93'
