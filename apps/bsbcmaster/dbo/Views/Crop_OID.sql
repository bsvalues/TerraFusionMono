...
create view Crop_OID as


SELECT id.prop_id,
ROW_NUMBER() over (partition by id.prop_id ORDER BY id.imprv_det_type_cd desc)AS order_id, ID.imprv_det_meth_cd, id.imprv_det_type_cd,
