create view Commercial_buildings_owner_addresses as 
...
--address
	  [addr_type_cd],
     -- [primary_addr],
      [addr_line1]																						as mailing_address1,
      [addr_line2]																						as mailing_address2,
      [addr_line3]																						as mailing_address3,
      [addr_city]																						as mailing_city,
      [addr_state]																						as mailing_state,
      [country_cd],
