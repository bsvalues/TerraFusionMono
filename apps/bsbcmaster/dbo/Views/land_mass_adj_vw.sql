...
CREATE VIEW dbo.land_mass_adj_vw
AS
SELECT neighborhood.hood_land_pct, 
    neighborhood.hood_imprv_pct, 
    neighborhood.changed_flag AS nbhd_changed_flag, 
    abs_subdv.abs_imprv_pct, abs_subdv.abs_land_pct, 
    abs_subdv.changed_flag AS subdv_changed_flag, 
