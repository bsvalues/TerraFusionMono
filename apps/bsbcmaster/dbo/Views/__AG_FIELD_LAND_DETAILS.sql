...
CREATE VIEW __AG_FIELD_LAND_DETAILS AS SELECT        property_val.prop_id, property_val.prop_val_yr, land_detail.land_type_cd, land_detail.land_soil_code, land_detail.size_acres, land_detail.sale_id AS Expr1, property_val.prop_inactive_dt
