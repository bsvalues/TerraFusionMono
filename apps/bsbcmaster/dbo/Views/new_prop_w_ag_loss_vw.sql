...
CREATE VIEW dbo.new_prop_w_ag_loss_vw
AS
...
FROM property_val INNER JOIN
    ...
    prop_w_ag_vw ON 
    prop_supp_assoc.prop_id = prop_w_ag_vw.prop_id AND 
    prop_supp_assoc.sup_num = prop_w_ag_vw.sup_num AND 
    prop_supp_assoc.owner_tax_yr = prop_w_ag_vw.prop_val_yr AND
     prop_supp_assoc.owner_tax_yr = prop_w_ag_vw.ag_eff_tax_year
     INNER JOIN
