...
create view [dbo].[__mosquito_wo_Exptions] as
SELECT     distinct b.prop_id,ab.year, ab.agency_id, ab.bill_id, sas.assessment_fee_amt, saa.assessment_cd, e.exmpt_type_cd,saa.assessment_description,XCoord,ycoord
