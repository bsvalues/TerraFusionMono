...
left join 
	(SELECT * from 
	 GIS_ppsf_range) as ppsf_r
				on land.prop_id= ppsf_r.prop_id
left join 
	(SELECT * from 
	 GIS_Building_Sppsf_range) as sppsf_r
				on land.prop_id= sppsf_r.prop_id
left join 
	(SELECT * from 
	 GIS_Building_ppsf_range) as bppsf_r
				on land.prop_id= bppsf_r.prop_id
