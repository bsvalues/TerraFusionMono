...
create view __aNew_Construction_shape as
SELECT pv.prop_id, a.file_as_name, ta.tax_area_number,	
(wpov.new_val_hs + wpov.new_val_nhs + wpov.new_val_p) as New_Value	,XCoord,YCoord, shape
