...
--create view __Apprest_gainloss_ as
--create view __aApprest_LandOnlySale_ as
SELECT DISTINCT 
...
left join 
  pacs_oltp.dbo._cComm_Occ_cd OCC 
		ON OCC.PROP_ID=pv.PROP_ID AND OCC.PROP_VAL_YR=pv.prop_val_yr AND OCC.SUP_NUM = pv.SUP_NUM
LEFT JOIN 
