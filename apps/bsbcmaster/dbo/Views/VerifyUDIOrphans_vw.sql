...
create view VerifyUDIOrphans_vw
as
select 
	pv.prop_id  ,
	...
	0 as owner_id,
	0 as entity_id,
	'UDI_ORPHAN' as check_cd,
	0 as ic_ref_id
from property_val as pv with(nolock)
left outer join
(
	select * from property_val as pvi with(nolock)
	where isnull(udi_parent,'') <> ''
) as ppv on
pv.prop_val_yr=ppv.prop_val_yr and
pv.udi_parent_prop_id=ppv.prop_id and
pv.sup_num=ppv.sup_num
where pv.udi_parent_prop_id is not null and ppv.prop_id is null and isnull(pv.udi_status,'') <> 'S'
