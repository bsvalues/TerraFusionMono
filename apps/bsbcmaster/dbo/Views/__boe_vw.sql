...
create view [dbo].[__boe_vw]
as


SELECT        property.prop_id AS ParcelID, property.geo_id, property.simple_geo_id, property_val.prop_val_yr AS CaseYear, property_val.sup_num AS SupNumber, account.file_as_name AS Owner, 
...
AS order_id,
[Prop_ID],[Shape].STCentroid().STX as XCoord,
