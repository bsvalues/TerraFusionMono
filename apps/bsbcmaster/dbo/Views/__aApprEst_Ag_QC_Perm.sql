create view __aApprEst_Ag_QC_Perm as 
SELECT DISTINCT 
...
pc.imprv_det_type_cd as crop
,pc.imprv_pc_acres as crop_acres
,pc.flat_adjusted as ag_flat_adj
,pc.Irrigated_Acres as irrigated_acres
,pc.Total_Legal_Acres as legal_acres,
...
left join 
[Benton_spatial_data].[dbo].[__crop_perm__]pc on pc.prop_id=pv.prop_id
