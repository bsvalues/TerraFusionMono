create view __error_report_view as
SELECT DISTINCT 
                         pv.prop_id, ap1.pacs_user_id, pv.last_appraiser_id, ap.appraiser_nm as next_appraiser , ap1.appraiser_nm as last_appraiser, pr.error, pr.error_id,
