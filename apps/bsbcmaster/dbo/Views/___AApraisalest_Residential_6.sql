create view ___AApraisalest_Residential_6 as
...
SELECT DISTINCT 
	...
	apy.class_cd																						AS class_cd_prior,
	...
	id.imprv_det_type_cd																				as House_type,
	...
	RTRIM(pu.property_use_cd)	+ ' (' + RTRIM(pu.property_use_desc)+ ')'														AS Property_Use_desc,
	...
	sales.sl_ratio_type_cd																					as sl_ratio_type_cd, 
	sales.sl_county_ratio_cd																					as sl_county_ratio_cd,
	sales.land_only_sale																						as land_only_sale,
	sales.recorded_dt,
	sales.comment,
...
left JOIN
                         imprv_adj iadj ON id.prop_id = iadj.prop_id
LEFT JOIN 
...
INNER JOIN
                         __aApprEst_prior_year  apy ON pv.prop_id = apy.ParcelID
--left join
	...
	--[CENTROID_X] as XCoord
     -- ,[CENTROID_Y] as YCoord
		...
		ON land.prop_id = coords.Prop_ID AND coords.order_id = 1
			...
			and pv.prop_inactive_dt is null	and situs.primary_situs= 'Y'and property.prop_type_cd='r'
			and pv.sup_num=0
