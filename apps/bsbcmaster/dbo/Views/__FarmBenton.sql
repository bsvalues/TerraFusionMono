...
LEFT JOIN Benton_spatial_data.dbo.perm_crop as perm on perm.prop_id=pv.prop_id

left join [Benton_spatial_data].[dbo].[__permcrop_view] as pd on pd.prop_id=perm.prop_id
