...
const logger = new Logger('CropHealthService');
...
// Start the server
const PORT = process.env.PORT ? parseInt(process.env.PORT) : 4008;
...
async function startServer() {
  try {
    ...
    logger.info(`🚀 Crop Health Analysis subgraph server running at ${url}`);
